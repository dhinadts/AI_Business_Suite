...
export declare class CompaniesService {
    ...
    constructor(prisma: PrismaService, classifier: CompanyClassifierService);
    getMine(companyId: string): Promise<{
        company: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    updateMine(companyId: string, dto: UpdateCompanyDto): Promise<{
        company: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
